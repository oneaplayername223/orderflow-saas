        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8 shadow-2xl">
            <div className="text-center mb-6">
              ...
              <p className="text-slate-400">Your order has been processed correctly</p>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-xl p-6 space-y-4 border border-slate-700/30">
              ...
              <div className="flex justify-between items-center pb-3 border-b border-slate-700/50">
                ...
                <span className="text-white font-semibold">{checkoutData.quantity} units</span>
              </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-4 md:p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-400">Complete your payment securely</p>
        </div>
